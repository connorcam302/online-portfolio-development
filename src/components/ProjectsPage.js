...
function ProjectsPage() {
    ...
    <div>
        ...
        <Box sx={{paddingTop:2, borderLeft:"3%",borderRight:"3%", display: 'flex', flexWrap: 'wrap',justifyContent: 'center',}}>
            <Link className="navText" to="largefutoshikigeneration"><ProjectThumbnail name="Large Futoshiki Generation" image={FutoshikiGeneration} java="true"software="true" complete="true"/></Link>
            ...
            <Link className="navText" to="vikingsesports"><ProjectThumbnail name="Vikings Esports Website" image={VikingsEsports} react="true" js="true" sqlite="true" php="true" software="true" complete="true"/></Link>
            ...
            <Link className="navText" to="thiswebsite"><ProjectThumbnail name="This Website" image={ThisWebsite} react="true" js="true" software="true"/></Link>
        </Box>
    </div>
    )
}
